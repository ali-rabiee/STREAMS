...
class jacoDiverseObjectEnv(gym.Env):
    ...
    def reset(self):
        ...
        pb.changeVisualShape(table, -1, rgbaColor=[0.98, 0.84, 0.67, 1])
        ...
        # Load random object in the environment
        ...
        pb.changeVisualShape(3, -1, rgbaColor=[0, 0.6, 0, 1])
